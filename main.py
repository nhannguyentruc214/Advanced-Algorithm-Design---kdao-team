    ...
    def train(self):
        ...
        for epoch in range(args.epoch):
            ...
            for idx in tqdm(range(n_batch)):
                ...
                pos_items_aug = [augmented_sample_dict[user][0] for user in users_aug if (user in augmented_sample_dict and augmented_sample_dict[user][0]<self.n_items and augmented_sample_dict[user][1]<self.n_items)]
                neg_items_aug = [augmented_sample_dict[user][1] for user in users_aug if (user in augmented_sample_dict and augmented_sample_dict[user][0]<self.n_items and augmented_sample_dict[user][1]<self.n_items)]
                users_aug = [user for user in users_aug if (user in augmented_sample_dict and augmented_sample_dict[user][0]<self.n_items and augmented_sample_dict[user][1]<self.n_items)]
